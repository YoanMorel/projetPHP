...
<html lang="FR">
    ...
    <body>
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom p-0 fixed-top">
       
      <img src="img/logo-ocordo-travaux.png" class="logo"/>
      ...
      <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav mr-auto" id="navbarLink">
          ...
          <li class="nav-item"> <a class="nav-link" href="#">Avis clients</a></li>
